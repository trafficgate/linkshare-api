...
makeRequest(
    $linkLocator,
    function (LinkLocator $provider) {
        $provider->merchantById(181);
    },
    $requestsPerMinute,
    $accessTokenPath
);
...
makeRequest(
    $linkLocator,
    function (LinkLocator $provider) {
        $provider->merchantByName('Target');
    },
    $requestsPerMinute,
    $accessTokenPath
);
...
makeRequest(
    $linkLocator,
    function (LinkLocator $provider) {
        $provider->merchantByAppStatus('approved');
    },
    $requestsPerMinute,
    $accessTokenPath
);
...
makeRequest(
    $linkLocator,
    function (LinkLocator $provider) {
        $provider->textLinks(-1, -1, null, null, -1, 1);
    },
    $requestsPerMinute,
    $accessTokenPath
);
...
makeRequest(
    $linkLocator,
    function (LinkLocator $provider) {
        $provider->bannerLinks(-1, -1, null, null, -1, -1, 1);
    },
    $requestsPerMinute,
    $accessTokenPath
);
...
makeRequest(
    $linkLocator,
    function (LinkLocator $provider) {
        $provider->drmLinks(-1, -1, null, null, -1, 1);
    },
    $requestsPerMinute,
    $accessTokenPath
);
